...
func (q *Queries) CreateRoomType(ctx context.Context, arg CreateRoomTypeParams) (RoomType, error) {
	row := q.db.QueryRowContext(ctx, createRoomType, arg.PropertyID, arg.Name, arg.MonthlyPrice)
	var i RoomType
	err := row.Scan(
		&i.ID,
		&i.PropertyID,
...
func (q *Queries) UpdateRoomType(ctx context.Context, arg UpdateRoomTypeParams) (RoomType, error) {
	row := q.db.QueryRowContext(ctx, updateRoomType, arg.ID, arg.Name, arg.MonthlyPrice)
	var i RoomType
	err := row.Scan(
		&i.ID,
		&i.PropertyID,
